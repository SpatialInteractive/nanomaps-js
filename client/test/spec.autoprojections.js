describe 'Projections'
	...
	describe 'WebMercator'
		it 'should forward transform (57.295780, 57.295780) to (6378137.000000,7820815.276085)'
			xy=Projections.WebMercator.forward({x: 57.29577951308232286465, y: 57.29577951308232286465})
		...
		it 'should inverse transform (6378137.000000, 7820815.276085) to (57.295780,57.295780)'
			xy=Projections.WebMercator.inverse({x: 6378137.00000000000000000000, y: 7820815.27608548197895288467})
		...
		it 'should forward transform (0.000000, 0.000000) to (0.000000,-0.000000)'
			xy=Projections.WebMercator.forward({x: 0.00000000000000000000, y: 0.00000000000000000000})
		...
		it 'should inverse transform (0.000000, -0.000000) to (0.000000,0.000000)'
			xy=Projections.WebMercator.inverse({x: 0.00000000000000000000, y: -0.00000000070811545516})
			xy.x.should.equal_approximately 0.00000000000000000000
		...
		it 'should forward transform (0.000000, 45.000000) to (0.000000,5621521.486192)'
			xy=Projections.WebMercator.forward({x: 0.00000000000000000000, y: 45.00000000000000000000})
			xy.x.should.equal_approximately 0.00000000000000000000
		...
		it 'should inverse transform (0.000000, 5621521.486192) to (0.000000,45.000000)'
			xy=Projections.WebMercator.inverse({x: 0.00000000000000000000, y: 5621521.48619206622242927551})
			xy.x.should.equal_approximately 0.00000000000000000000
		...
		it 'should forward transform (0.000000, 85.000000) to (0.000000,19971868.880409)'
			xy=Projections.WebMercator.forward({x: 0.00000000000000000000, y: 85.00000000000000000000})
			xy.x.should.equal_approximately 0.00000000000000000000
		...
		it 'should inverse transform (0.000000, 19971868.880409) to (0.000000,85.000000)'
			xy=Projections.WebMercator.inverse({x: 0.00000000000000000000, y: 19971868.88040856271982192993})
			xy.x.should.equal_approximately 0.00000000000000000000
		...
		it 'should inverse transform (0.000000, -19971868.880409) to (0.000000,-85.000000)'
			xy=Projections.WebMercator.inverse({x: 0.00000000000000000000, y: -19971868.88040857017040252686})
			xy.x.should.equal_approximately 0.00000000000000000000
		...
		it 'should forward transform (180.000000, 0.000000) to (20037508.342789,-0.000000)'
			xy=Projections.WebMercator.forward({x: 180.00000000000000000000, y: 0.00000000000000000000})
		...
		it 'should inverse transform (20037508.342789, -0.000000) to (180.000000,0.000000)'
			xy=Projections.WebMercator.inverse({x: 20037508.34278924390673637390, y: -0.00000000070811545516})
		...
		it 'should forward transform (45.000000, 45.000000) to (5009377.085697,5621521.486192)'
			xy=Projections.WebMercator.forward({x: 45.00000000000000000000, y: 45.00000000000000000000})
		...
		it 'should inverse transform (5009377.085697, 5621521.486192) to (45.000000,45.000000)'
			xy=Projections.WebMercator.inverse({x: 5009377.08569731097668409348, y: 5621521.48619206622242927551})
